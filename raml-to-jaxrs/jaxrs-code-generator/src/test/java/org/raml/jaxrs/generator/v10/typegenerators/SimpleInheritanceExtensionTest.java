...
public class SimpleInheritanceExtensionTest {
  ...
  private void setupMocking() {
    ...
    when(typeExtension.onType(eq(typeContext), isNull(TypeSpec.Builder.class), eq(type), eq(BuildPhase.INTERFACE)))
        .thenAnswer(
    ...
    when(typeExtension.onType(eq(typeContext), any(TypeSpec.Builder.class), eq(type), eq(BuildPhase.INTERFACE)))
        .thenAnswer(
                    new Answer<TypeSpec.Builder>() {
    ...
    when(typeContext.onType(eq(typeContext), any(TypeSpec.Builder.class), eq(type), eq(BuildPhase.INTERFACE)))
        .thenAnswer(
                    new Answer<TypeSpec.Builder>() {
