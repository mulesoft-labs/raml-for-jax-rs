...
import static org.raml.jaxrs.generator.builders.types.TypeBuilderHelpers.forField;
import static org.raml.jaxrs.generator.builders.types.TypeBuilderHelpers.forParameter;
import static org.raml.jaxrs.generator.builders.types.TypeBuilderHelpers.forReturnValue;
...
public class TypeBuilderImplementation implements TypeBuilder {
    ...
    public void ouput(String rootDirectory) throws IOException {
        ...
        for (PropertyInfo propertyInfo : propertyInfos.values()) {
            ...
            build.javaTypeName(propertyInfo.getType(), forField(build, typeSpec, propertyInfo.getName()));
            ...
            ;
            build.javaTypeName(propertyInfo.getType(), forReturnValue(build, getSpec));
            ...
            build.javaTypeName(propertyInfo.getType(), forParameter(build, setSpec, propertyInfo.getName()));
