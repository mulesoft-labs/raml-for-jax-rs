...
public class JerseyMultipartFormDataResourceExtensionTest {
    ...
    public void simpleHappyTest() {
        ...
        Api api = RamlDocumentBuilder.document().title("any").withResources(
                ResourceBuilder.resource("/foo").withMethods(
                        MethodBuilder.method("post")
                            .withBodies(
                                    BodyBuilder.body("multipart/form-data")
                                            .ofType(TypeBuilder.type("object")
                                                    .withProperty(TypePropertyBuilder.property("one", "file")))))).buildModel();
        ...
        assertEquals(ClassName.bestGuess("org.glassfish.jersey.media.multipart.FormDataParam"), m.parameters.get(0).annotations.get(0).type);
        ...
        assertEquals(ClassName.bestGuess("org.glassfish.jersey.media.multipart.FormDataParam"), m.parameters.get(1).annotations.get(0).type);
    ...
    public void ramlType() {
        ...
        Api api = RamlDocumentBuilder.document().title("any")
                .withTypes(
                ...
                ResourceBuilder.resource("/foo").withMethods(
                        MethodBuilder.method("post")
                                .withBodies(
                                        BodyBuilder.body("multipart/form-data")
                                                .ofType(TypeBuilder.type("object")
                                                        .withProperty(TypePropertyBuilder.property("one", "User")))))).buildModel();
