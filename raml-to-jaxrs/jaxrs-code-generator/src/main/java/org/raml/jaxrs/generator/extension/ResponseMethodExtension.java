...
public interface ResponseMethodExtension {
    ...
    ResponseMethodExtension NULL_EXTENSION = new ResponseMethodExtension() {
        ...
        @Override
        public MethodSpec.Builder onMethod(CurrentBuild build, V10GResponse method, MethodSpec.Builder methodSpec) {
            return methodSpec;
        }
    };

    MethodSpec.Builder onMethod(CurrentBuild build, V10GResponse method, MethodSpec.Builder methodSpec);
}
