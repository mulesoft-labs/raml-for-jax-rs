...
at first you should install our plugin, to do it go to core project and run mvn install, then go to maven-plugin and run mvn install again, now you are ready to use it.
