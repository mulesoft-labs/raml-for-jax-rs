...
public enum ScalarType implements RamlType {
  NUMBER("number", ImmutableList.<Type>of(float.class, Float.class, double.class, Double.class)), BOOLEAN(
      "boolean", ImmutableList.<Type>of(boolean.class, Boolean.class)), STRING("string",
      ImmutableList.<Type>of(String.class)), DATE_ONLY("date-only", ImmutableList.<Type>of()), TIME_ONLY(
      "time-only", ImmutableList.<Type>of()), DATETIME_ONLY("datetime-only", ImmutableList
      .<Type>of()), DATETIME("datetime", ImmutableList.<Type>of()), FILE("file", ImmutableList
      .<Type>of()),
  ...
  INTEGER("integer", ImmutableList.<Type>of(int.class, Integer.class, byte.class, Byte.class,
                                            short.class, Short.class, long.class, Long.class)), NIL("nil", ImmutableList
      .<Type>of());
